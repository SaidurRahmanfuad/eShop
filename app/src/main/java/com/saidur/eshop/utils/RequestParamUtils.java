...
public class RequestParamUtils {
    ...
    public static final String appVersions = "app-vers";
    public static final String sendconfirmemail = "send_confirmation_email";
    ...
    public static final String IsUserExists = "IsUserExists";
